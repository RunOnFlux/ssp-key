...
// pairing cross-check, which hashes the full strings. These constants and the
// known-vector expectations are byte-identical to ssp-wallet's spec, which is
// how this pure test also guards cross-repo parity (the source is identical).
const WALLET_XPUB =
